...
public class checkpoint_methods extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.checkpoint_methods);
        ...
        b_pick.setOnClickListener(new View.OnClickListener() {  //Button for setting date and time
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(checkpoint_methods.this,
                        checkpoint_methods.this, year, month, day);
    ...
    public void onDateSet(DatePicker datePicker, int i, int i1, int i2){
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(checkpoint_methods.this,
                checkpoint_methods.this, hour, minute, true);
